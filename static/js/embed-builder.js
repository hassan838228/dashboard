...
window.onload = () => {
  ...
  let editorHolder = document.querySelector(".editorHolder"),
    ...
    json = {
      content:
        "This is a Message Embed <:emoji_27:948966291694317568>\nEverything is _Customizable_ including **Emojis**\nYou can~~not~~ also do `this`.```py\nAnd ('this')```",
      embed: {
        title: "Hello! :wave:",
        description:
          "You can use [links](https://c-bot.click) or emojis :smile: :eyes:\n```\nAnd also code blocks\n```",
        color: 4321431,
        timestamp: new Date().toISOString(),
        url: "https://c-bot.click",
        author: {
          name: "Author name",
          url: "https://c-bot.click",
          icon_url: "https://c-bot.click/logo.png",
        },
        thumbnail: {
  ...
  $(document).on("click", "#save-custom", function (e) {
    ...
    error(
      'Successfully saved command, if not saved, <a href="https://cBot.cbotcbot.repl.co/embeds">read here</a>',
      10000
    );
    e.preventDefault();
    $.ajax({
